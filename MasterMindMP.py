...
class MastermindGame:
    ...
    def endGame(self):
        ...
        winningScore = self.playerScores[winningPlayer]
        ...
        if winningScore > lowestHighScore or len(highScores) < 5:
            ...
            print("Game over! Correct pattern:", " ".join(map(str, self.secretPattern)))
            print(f"Game duration: {time.strftime('%M minutes and %S seconds', time.gmtime(self.endTime - self.startTime))}")
